Rails.application.routes.draw do
  ...
  delete 'delete_benefit_app/:benefit_app_id' => 'benefits_applications#delete_benefit_app',
         as: :delete_benefit_app
  ...
  get 'benefits_apps/:benefit_app_id', to: 'benefits_applications#edit_benefits_app',
                                       as: :edit_benefits_app
  get 'delete_member/:member_id' => 'benefits_applications#delete_member', as: :delete_member
  patch 'update_benefits_apps/:benefit_app_id', to: 'benefits_applications#update_benefits_app',
                                                as: :update_benefits_app
  patch 'update_benefits_apps/:benefit_app_id', to: 'benefits_applications#update_benefits_app',
                                                as: :benefit_app
